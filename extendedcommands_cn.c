...
int show_install_update_menu()
{
    ...
    static const char* headers[] = {  "安装Zip刷机包",
                                "",
                                NULL
    };
    ...
    install_menu_items[1] = "从adb sideload读取刷机包";

    install_menu_items[2] = "刷机包签名检测开关";
...
void show_choose_zip_menu(const char *mount_point)
{
    ...
    static const char* headers[] = {  "选中一个刷机包",
                                "",
                                NULL
    };
...
void show_nandroid_restore_menu(const char* path)
{
    ...
    static const char* headers[] = {  "选择一个备份还原",
                                "",
                                NULL
    };
...
void show_nandroid_delete_menu(const char* path)
{
    ...
    static const char* headers[] = {  "选择一个备份删除",
                                "",
                                NULL
    };
...
{
    static const char* headers[] = {  "挂载和大容量储存",
                                "",
                                NULL
    };
    ...
    for (;;)
    {
        ...
        if (!is_data_media()) {
            list[mountable_volumes + formatable_volumes] = "打开U盘模式";
            list[mountable_volumes + formatable_volumes + 1] = '\0';
        } else {
            list[mountable_volumes + formatable_volumes] = "格式化 /data(包括内置储存)";
            list[mountable_volumes + formatable_volumes + 1] = "打开U盘模式";
...
void show_nandroid_advanced_restore_menu(const char* path)
{
    ...
    static const char* advancedheaders[] = {  "选择一个备份",
                                "",
                                "请先选中一个备份.",
                                "下一步有更多选项.",
                                "",
    ...
    static const char* headers[] = {  "高级还原菜单",
                                "",
                                NULL
    };
...
static void choose_default_backup_format() {
    static const char* headers[] = {  "选择备份格式",
                                "",
                                NULL
    };
...
int show_advanced_menu()
{
    ...
    static const char* headers[] = {  "高级选项菜单",
                                "",
                                NULL
    };
    ...
    for (;;)
    {
        ...
        switch (chosen_item)
        {
            ...
            case 3:
                ...
                if (confirm_selection( "确认清除?", "是的,清除dalvik cache")) {
...
void handle_failure(int ret)
{
    ...
    ui_print("/tmp/recovery.log已经复制到/sdcard/clockworkmod/recovery.log. 请打开ROM Manager来发送此报告.\n");
}
